 ...
 console.log(orderList)
  ...
  return (
    <div className="p-4 bg-white">
      <form
        className="m-auto w-full max-w-md  shadow flex flex-col p-3 bg-white/70"
      ...
      >
        ...
        {loading ? (
          ...
          <button className="bg-[rgb(233,142,30)] hover:bg-orange-600 text-white text-lg font-medium p-1 rounded my-2 drop-shadow">
            Save
          </button>
        )}
      </form>
      ...
      <div className="m-auto w-full max-w-md  shadow flex flex-col p-3 bg-white/70">
        ...
        <button
          ...
          onClick={() => navigate(`/newproduct/${location}`)}
        >
          GO
        </button>
      </div>
      ...
      <div className="m-auto w-full max-w-md  shadow flex flex-col p-3 bg-white/70">
        <h2>Order List</h2>
        <button className="w-auto m-auto  bg-[rgb(233,142,30)] hover:bg-orange-600 cursor-pointer text-white text-center p-2 rounded mt-4">Refresh Order-List</button>
        {orderList?.map(item=>{
